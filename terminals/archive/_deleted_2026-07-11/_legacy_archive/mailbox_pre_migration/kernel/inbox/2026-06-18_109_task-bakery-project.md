...
# Auto-dispatched Task: bakery-project

## Feladat

Dolgozd fel az alábbi tervdokumentumot és implementáld:

**Forrás:** `docs/tasks/active/bakery-project.md`

## Instrukciók

1. Olvasd be a tervdokumentumot
2. Elemezd mit kell csinálni
3. Implementáld lépésenként
4. Tesztelj minden lépés után
5. DONE outbox ha kész

## Referencia

A teljes tervdokumentum tartalma:
...
**Auto-dispatched by task-dispatcher.sh**
