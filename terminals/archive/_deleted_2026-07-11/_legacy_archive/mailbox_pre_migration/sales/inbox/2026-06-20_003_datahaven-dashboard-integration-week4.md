...
A **Datahaven Dashboard** központi monitoring rendszer élesedett és a Sales terminál Week 4 migráció részeként frissült.

### Mi változott?

A `backend/spaceos-modules-sales/CLAUDE.md` fájlod frissült az alábbi szekciókkal:
...
- **Dashboard oldal:** Sales terminál státusza, inbox/outbox count
- **Kanban oldal:** Sales swimlane (Delivery track) — inbox/working/review/done
...
A Sales a Week 4 új polyrepo — Quote, SalesOrder, Outbox pattern (Port 5009, NOT DEPLOYED).
