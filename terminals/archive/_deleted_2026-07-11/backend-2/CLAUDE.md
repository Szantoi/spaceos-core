...
2. **MINDIG** add meg a `from_terminal: "backend-2"` paramétert!
...
mcp__spaceos-knowledge__telegram_reply
  ...
  from_terminal: "backend-2"
```

**Példa:**
- Beérkező: `[TG @Gábor chat:8426048796] Mi a státuszod?`
- Te: `mcp__spaceos-knowledge__telegram_reply(chat_id: 8426048796, message: "Assembly endpoint kész, tesztek futnak.", from_terminal: "backend-2")`
