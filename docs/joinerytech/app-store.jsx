...
(function () {
  ...
  const api = {
    ...
    // Wires in 5 domain slices (CRM, Sales, Warehouse, Production, Catalog)
    // via observable adapter pattern. Actions dynamically generated from slices.
    // window.StoreAdapter loaded from stores-bundle.js
