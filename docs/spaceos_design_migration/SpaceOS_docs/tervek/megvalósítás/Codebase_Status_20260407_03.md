...
|---|---|---|---|---|---|
| **SpaceOS.Kernel** | L2 Backend | .NET 8, EF Core 8, PostgreSQL | `DEPLOYED` | 913 pass / 0 fail | 0 error, 0 warning |
| **SpaceOS.Orchestrator** | L3 BFF | Node.js 22, TypeScript 5, Express 4 | `DEPLOYED` | 150 pass / 0 fail | 0 TS error |
...
**Összesített tesztszám: 1382 pass / 0 fail**
...
**Mailbox:** MSG-K026 (DONE) · MSG-O010 (DONE) · MSG-P017 (⏳ Portal sync-types folyamatban)
...
| ⏳ | Portal `npm run sync-types` + `ChainVerificationDto.wormStorageAvailable` típus | MSG-P017/P018 |
...
- [ ] Portal `npm run sync-types` sikeres + `ChainVerificationDto.wormStorageAvailable` megjelenik
...
### Kernel — 913 pass / 0 fail (+99 Sprint D Phase 3B)

| Teszt projekt | Phase 3A után | Phase 3A fix | Phase 3B után | Delta (3B) |
|---|---|---|---|---|
| SpaceOS.Kernel.Tests (unit) | 645 | 645 | 744 | +99 |
| SpaceOS.Kernel.Api.Tests (API) | 101 | 101 | 101 | 0 |
| SpaceOS.Kernel.IntegrationTests | 68 | 68 | 68 | 0 |
| **Összesen** | **814** | **814** | **913** | **+99** |
...
### Orchestrator — 150 pass / 0 fail (+24 Sprint D Phase 3B)
...
| D-P3B-portal | Portal sync-types + ChainVerificationPanel + SnapshotHistoryPanel + ProofHash UI | P1 | `FOLYAMATBAN` (MSG-P017/P018) |
| D-P3C | Spatial Portal UI (SpaceViewer, SpatialTimelinePage) | P2 | `NYITOTT` |
