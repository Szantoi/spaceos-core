...
**Utolsó frissítés:** 2026-04-13 (MSG-INFRA-069-DONE: d6b1bad VPS live · MSG-E2E-012 kiadva · várt: 147/151 → E2E bővítés: 36-proof / 37-tools / 34-abstractions-deep)
**Tesztelő:** Gabor
...
|---|---|---|---|---|---|
| **SpaceOS.Kernel** | L2 Backend | .NET 8, EF Core 8, PostgreSQL | `DEPLOYED` | 1084 pass / 0 fail (4 skip) · commit d6b1bad | 0 error, 0 warning |
| **SpaceOS.Orchestrator** | L3 BFF | Node.js 22, TypeScript 5, Express 4 | `DEPLOYED` | **183 pass** / 0 fail | 0 TS error |
| **SpaceOS.DesignPortal** | L4 Frontend | React 18 + Turborepo monorepo, TypeScript 5, Vite | `DEPLOYED` | 291 pass / 0 fail | 0 TS error |
| **E2E** | Full stack | Vitest + fetch | `RUNNING` | utolsó mért: **119/151** (regresszió) · d6b1bad live · **147/151 várható** · E2E-012 fut | MSG-E2E-012 kiadva |
...
| **SpaceOS.Modules.Abstractions** | L2 Module | .NET 8, EF Core 8, PostgreSQL `spaceos_abstractions` | `DEPLOYED` | 61 pass / 0 fail | 0 error, 0 warning |

**Összesített tesztszám: 1728+ pass / 0 fail** (1084 Kernel + 183 Orchestrator + 291 Portal + 109 Joinery + 61 Abstractions · E2E: 119/151 (fix deploy után: 147+/151))
...
| **ClaimsTenantResolver + TenantSessionInterceptor végleges fix** | tid-first prioritás + graceful fallback + TSI c62f1d7 revert · 1084 teszt | `DEPLOYED` ✅ | — | MSG-INFRA-069-DONE elfogadva · commit d6b1bad · VPS live 2026-04-13 |
| **Kernel VPS deploy 316f603** | ClaimsTenantResolver fix élesítése a VPS-en · HEAD: 75ed3bd | `SUPERSEDED` | — | Regresszió 119/151 maradt → d6b1bad váltja fel |
| **E2E bővítés** | Batch 1: 29/30/31 pass · 34-abstractions ORCH-059 után | `PARTIAL` | E2E | MSG-E2E-005-DONE-K1 elfogadva |
| **E2E Batch 3 — proof chain** | 36-proof.chain.test.ts · teljesítésigazolás (beszerelő → megrendelő) | `PLANNED` | E2E-012 rerun (147/151) | Doorstar Q2 kritikus |
| **E2E Batch 3 — tools chain** | 37-tools.chain.test.ts · LLM tool calling registry | `PLANNED` | 36-proof után | AI-natív architektúra alapja |
| **E2E Batch 3 — abstractions deep** | 34-abstractions-deep.chain.test.ts · cutting-list + cnc-plan + process-plan | `PLANNED` | 37-tools után | 2026 Q3 szabászat modul előfeltétele |
