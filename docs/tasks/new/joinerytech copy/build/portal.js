/* AUTO-GENERATED from portal.jsx — NE SZERKESZD, a forrás a .jsx! */
(function(){
// ──────────────────────────────────────────────────────────────────────────
...
const PERM_CATALOG = [{
  ...
  key: "quote.convert",
  label: "Konvertálás rendeléssé"
}, {
  key: "order.release",
  label: "Gyártásba adás"
}, {
  key: "order.track",
  label: "Rendeléskövetés"
}, {
  key: "forward",
  label: "Továbbajánlás (B2B2C)"
}, {
  key: "catalog.approve",
  label: "Cikkszám jóváhagyása"
}, {
  key: "design.engineer",
  label: "Műszaki tervezés (sablon-kiadás)"
}, {
  key: "finance.manage",
  label: "Pénzügy kezelése"
}, {
  key: "hr.manage",
  label: "HR / távollét kezelése"
}, {
  key: "maintenance.manage",
  label: "Karbantartás kezelése"
}, {
  key: "crm.manage",
  label: "CRM / pipeline kezelése"
}, {
  key: "rfq.manage",
  label: "Ajánlatkérés odaítélése"
}, {
  key: "auth.approve",
  label: "Hatáskör-jóváhagyás (limit felett)"
}, {
  key: "quality.manage",
  label: "Minőségellenőrzés kezelése"
}, {
  key: "ehs.manage",
  label: "Munkavédelem kezelése"
}, {
  key: "controlling.exec",
  label: "Vezetői áttekintés (BI-cockpit)"
}, {
  key: "docs.manage",
  label: "Dokumentumtár kezelése"
}, {
  key: "attendance.manage",
  label: "Jelenlét jóváhagyása"
}, {
  key: "settings.manage",
  label: "Hozzáférés kezelése"
}, {
  key: "supplier.portal",
  label: "Beszállítói portál (külső)"
}];
...
function ProfileSwitcher({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("button", {
    ...
    className: `w-7 h-7 rounded-full grid place-items-center text-[11px] font-semibold ${ACCOUNT_TYPE_TONE[me.type]}`
  }, acctInitials(me.name)), /*#__PURE__*/React.createElement("span", {
    className: "hidden sm:flex flex-col items-start leading-tight"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-[11.5px] font-semibold text-stone-900 max-w-[140px] truncate"
  }, me.name), /*#__PURE__*/React.createElement("span", {
    className: "text-[9.5px] text-stone-500"
  }, me.role)), /*#__PURE__*/React.createElement(Icon, {
    name: "chevron",
    size: 13,
    className: "text-stone-400 rotate-90"
  })), open && /*#__PURE__*/React.createElement(ProfileSheet, {
    s: s,
    me: me,
...
function ProfileSheet({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "absolute inset-x-0 bottom-0 md:inset-auto md:right-5 md:top-16 md:w-[380px] bg-white rounded-t-2xl md:rounded-2xl shadow-2xl border border-stone-200 flex flex-col overflow-hidden max-h-[86vh] md:max-h-[80vh] animate-[chSlide_.22s_ease-out]",
    style: {
    ...
    className: "px-4 pt-2.5 pb-3 border-b border-stone-200 flex items-center justify-between"
  }, /*#__PURE__*/React.createElement("div", {
    className: "text-[13px] font-semibold text-stone-900"
  }, "Profil v\xE1lt\xE1sa"), /*#__PURE__*/React.createElement("button", {
    onClick: onClose,
    ...
    return /*#__PURE__*/React.createElement("div", {
      key: a.id,
      className: `border-b border-stone-100 ${active ? "bg-teal-50/40" : ""}`
    }, /*#__PURE__*/React.createElement("div", {
      className: "px-4 py-3 flex items-center gap-3"
    }, /*#__PURE__*/React.createElement("span", {
      className: `w-9 h-9 rounded-full grid place-items-center text-[12px] font-semibold ${ACCOUNT_TYPE_TONE[a.type]}`
    }, acctInitials(a.name)), /*#__PURE__*/React.createElement("button", {
      onClick: () => {
        window.sim.setAccount(a.id);
        onClose();
      },
      ...
      className: `text-[9px] px-1.5 py-0.5 rounded-full font-bold ${ACCOUNT_TYPE_TONE[a.type]}`
    }, ACCOUNT_TYPE_LABEL[a.type])), /*#__PURE__*/React.createElement("div", {
      className: "text-[10.5px] text-stone-500 truncate"
    }, a.role, " \xB7 ", a.contact), /*#__PURE__*/React.createElement("div", {
      className: "text-[10px] text-stone-400 mt-0.5 truncate"
    }, a.worlds.map(w => WORLD_LABELS[w]).join(" · "))), active && /*#__PURE__*/React.createElement("span", {
      className: "text-teal-600 shrink-0"
    }, /*#__PURE__*/React.createElement(Icon, {
      name: "check",
      size: 16
    })), canManage && /*#__PURE__*/React.createElement("button", {
      onClick: () => setConfigId(configId === a.id ? null : a.id),
      "aria-label": "Hozz\xE1f\xE9r\xE9s",
      ...
      name: "settings",
      size: 15
    }))), canManage && configId === a.id && /*#__PURE__*/React.createElement(AccessConfig, {
      acc: a
    }));
  })), /*#__PURE__*/React.createElement("div", {
    className: "px-4 py-2.5 border-t border-stone-200 bg-stone-50/60 text-[10.5px] text-stone-500 leading-relaxed"
  }, "A c\xE9g a saj\xE1t \xFCgymenet\xE9hez igaz\xEDthatja a port\xE1lt: aktiv\xE1lja a sz\xFCks\xE9ges ablakokat \xE9s jogosults\xE1gokat fi\xF3konk\xE9nt.")), /*#__PURE__*/React.createElement("style", null, `@keyframes chSlide{from{transform:translateY(14px);opacity:.6}to{transform:translateY(0);opacity:1}}`));
}
function AccessConfig({
  acc
}) {
  return /*#__PURE__*/React.createElement("div", {
    className: "px-4 pb-3.5 pt-1 bg-stone-50/60 space-y-3"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    className: "text-[10px] uppercase tracking-wide text-stone-500 font-medium mb-1.5"
  }, "Aktiv\xE1lt ablakok"), /*#__PURE__*/React.createElement("div", {
    className: "flex flex-wrap gap-1.5"
  }, Object.keys(WORLD_LABELS).map(w => {
    const on = acc.worlds.includes(w);
    return /*#__PURE__*/React.createElement("button", {
      key: w,
      onClick: () => window.sim.toggleAccountWorld(acc.id, w),
    ...
    className: "text-[10px] uppercase tracking-wide text-stone-500 font-medium mb-1.5"
  }, "Jogosults\xE1gok"), /*#__PURE__*/React.createElement("div", {
    className: "space-y-1"
  }, PERM_CATALOG.map(p => {
    ...
    return /*#__PURE__*/React.createElement("label", {
      ...
      onClick: () => window.sim.toggleAccountPerm(acc.id, p.key),
      "aria-pressed": on,
...
function ForwardQuoteSheet({
  ...
  const submit = () => {
    ...
    window.sim.forwardQuote(quote.id, customer.trim(), markup);
    onClose();
  };
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "absolute inset-x-0 bottom-0 md:inset-auto md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:w-[420px] bg-white rounded-t-2xl md:rounded-2xl shadow-2xl border border-stone-200 overflow-hidden animate-[chSlide_.22s_ease-out]",
    style: {
      paddingBottom: "max(env(safe-area-inset-bottom), 0px)"
    }
  }, /*#__PURE__*/React.createElement("div", {
    className: "px-5 pt-4 pb-3 border-b border-stone-200"
  }, /*#__PURE__*/React.createElement("div", {
    className: "text-[14px] font-semibold text-stone-900"
  }, "Aj\xE1nlat tov\xE1bbaj\xE1nl\xE1sa"), /*#__PURE__*/React.createElement("div", {
    className: "text-[11.5px] text-stone-500 mt-0.5"
  }, quote.id, " \xB7 ", quote.customer, " \u2192 saj\xE1t \xFCgyf\xE9l")), /*#__PURE__*/React.createElement("div", {
    className: "px-5 py-4 space-y-4"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "block text-[11px] text-stone-500 mb-1"
  }, "\xDCgyf\xE9l (c\xEDmzett) ", /*#__PURE__*/React.createElement("span", {
    className: "text-rose-500"
  }, "*")), /*#__PURE__*/React.createElement("input", {
    value: customer,
    onChange: e => setCustomer(e.target.value),
    placeholder: "pl. Kis Lak\xE1sst\xFAdi\xF3 Kft.",
  ...
  }, "Beszerz\xE9si \xE1r"), /*#__PURE__*/React.createElement("div", {
    className: "text-[13px] font-mono text-stone-600 tabular-nums"
  }, base.toLocaleString("hu-HU"), " Ft")), /*#__PURE__*/React.createElement(Icon, {
    name: "chevron",
    size: 16,
    ...
    className: "text-[10px] uppercase tracking-wide text-teal-600"
  }, "\xDAj aj\xE1nlati \xE1r"), /*#__PURE__*/React.createElement("div", {
    className: "text-[15px] font-mono font-semibold text-stone-900 tabular-nums"
  }, out.toLocaleString("hu-HU"), " Ft")))), /*#__PURE__*/React.createElement("div", {
