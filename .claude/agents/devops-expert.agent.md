...
skills:
  ...
  - '@conventional-commit'
tools: ['codebase', 'edit/editFiles', 'terminalCommand', 'search', 'githubRepo', 'runCommands', 'runTasks', 'mcp__context7__resolve-library-id', 'mcp__context7__query-docs', 'mcp__ref__ref_search_documentation', 'mcp__ref__ref_read_url', 'mcp__brave-search__brave_web_search']
---
...
| Situation | Tool |
|---|---|
| CI/CD tool, Docker, nginx, pm2 docs | `context7` — resolve-library-id → query-docs |
| Konkrét docs URL olvasása | `ref` — ref_read_url |
| Dokumentációban keresés | `ref` — ref_search_documentation |
| Pipeline konfig minta, infra pattern, deployment stratégia | `brave_web_search` |
