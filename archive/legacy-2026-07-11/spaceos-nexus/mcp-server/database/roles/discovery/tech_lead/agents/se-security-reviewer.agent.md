...
1. **Code type?**
   - Web API â?? OWASP Top 10
   - AI/LLM integration â?? OWASP LLM Top 10
   - ML model code â?? OWASP ML Security
   - Authentication â?? Access control, crypto
...
3. **Business constraints?**
   - Performance critical â?? Prioritize performance checks
   - Security sensitive â?? Deep security review
   - Rapid prototype â?? Critical security only
