...
title: "Implementation Report Template (Backend)"
description: "Technical evidence of Task completion for backend development. Fill out after implementing a task; summarize changes using the Fact Summary Pattern."
type: template
scope: backend
...
- Commands (e.g. `dotnet test`, `npm run test`)
