...
| `project_phase3c_closedloop_findings.md` | project | Phase 3C+ full scan 2026-04-09 — 1 ERROR (S-01 RLS COALESCE), 8 WARNINGs. SECURITY_FAILED. Migration 0028 required to unblock. |
