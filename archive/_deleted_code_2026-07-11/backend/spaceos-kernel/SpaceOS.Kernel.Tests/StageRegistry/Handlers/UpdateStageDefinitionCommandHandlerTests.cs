// SpaceOS.Kernel.Tests/StageRegistry/Handlers/UpdateStageDefinitionCommandHandlerTests.cs
using System;
...
/// <summary>Unit tests for <see cref="UpdateStageDefinitionCommandHandler"/>.</summary>
public sealed class UpdateStageDefinitionCommandHandlerTests
{
    ...
    private readonly UpdateStageDefinitionCommandHandler _handler;
    ...
    public UpdateStageDefinitionCommandHandlerTests()
    {
        _handler = new UpdateStageDefinitionCommandHandler(
            _repository.Object,
            _unitOfWork.Object,
            _dispatcher.Object);
    }
    ...
    public async Task Handle_ExistingDefinition_ReturnsSuccess()
    {
        ...
        var command = new UpdateStageDefinitionCommand(definition.Id, "http://127.0.0.1:5001");
    ...
    public async Task Handle_UnknownId_ReturnsNotFound()
    {
        ...
        var command = new UpdateStageDefinitionCommand(Guid.NewGuid(), "http://127.0.0.1:5001");
