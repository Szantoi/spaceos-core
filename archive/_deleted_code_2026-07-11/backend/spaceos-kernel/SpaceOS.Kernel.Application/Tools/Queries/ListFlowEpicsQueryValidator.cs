// SpaceOS.Kernel.Application/Tools/Queries/ListFlowEpicsQueryValidator.cs
using FluentValidation;

namespace SpaceOS.Kernel.Application.Tools.Queries;

/// <summary>Validates <see cref="ListFlowEpicsQuery"/> pagination parameters.</summary>
internal sealed class ListFlowEpicsQueryValidator : AbstractValidator<ListFlowEpicsQuery>
{
    /// <summary>Initialises the pagination validation rules.</summary>
    public ListFlowEpicsQueryValidator()
    {
