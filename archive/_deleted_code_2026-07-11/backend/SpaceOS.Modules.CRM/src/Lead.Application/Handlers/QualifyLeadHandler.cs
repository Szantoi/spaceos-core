...
/// </summary>
public sealed class QualifyLeadHandler : IRequestHandler<QualifyLeadCommand, Result<LeadResponse>>
{
    ...
    public async Task<Result<LeadResponse>> Handle(QualifyLeadCommand request, CancellationToken cancellationToken)
    {
