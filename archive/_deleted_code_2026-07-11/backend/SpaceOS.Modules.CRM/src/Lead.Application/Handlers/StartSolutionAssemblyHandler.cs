...
/// </summary>
public sealed class StartSolutionAssemblyHandler : IRequestHandler<StartSolutionAssemblyCommand, Result<OpportunityResponse>>
{
    ...
    public async Task<Result<OpportunityResponse>> Handle(StartSolutionAssemblyCommand request, CancellationToken cancellationToken)
    {
