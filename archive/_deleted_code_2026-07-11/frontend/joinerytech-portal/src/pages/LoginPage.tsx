...
type LoginMode = 'login' | 'sso' | 'forgot'
...
export function LoginPage() {
  ...
  const handleGoogleLogin = () => {
    // Trigger Keycloak with Google IDP
    login()
  }

  const handleSSOLogin = () => {
    // Trigger Keycloak SSO
    login()
  }

  const handleForgotPassword = () => {
    // Show success message and return to login
    alert('Visszaállító link elküldve az email címedre.')
    setMode('login')
  }
      ...
      <aside className="hidden lg:flex flex-col w-[44%] xl:w-[48%] relative overflow-hidden bg-stone-900 text-stone-100">
        ...
        <div className="relative px-12 pb-10 flex items-center justify-between text-[11px] text-stone-400">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="#help" className="hover:text-stone-200">
              Súgó
            </a>
          </div>
        </div>
      ...
      <main className="flex-1 flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center px-5 py-10">
          <div className="w-full max-w-[400px]">
            {mode === 'login' && (
              <form onSubmit={handleSubmit}>
                ...
                <div className="mt-6 pt-5 border-t border-stone-100 text-center text-[12px] text-stone-500">
                  Még nincs fiókod?{' '}
                  <a href="#register" className="text-teal-700 font-medium hover:underline cursor-pointer">
                    Regisztráció
                  </a>
                </div>
                ...
                <div className="mt-5 p-3 rounded-lg bg-amber-50/70 border border-amber-200/60 text-[11px] text-amber-900 leading-relaxed">
                  <span className="font-semibold">Demo:</span> kattints bármely bejelentkezési gombra a Keycloak
                  auth flow indításához. Üzem (Shop Floor) belépéshez ne itt jelentkezz be — a portál Home oldalán
                  válaszd az „Üzem" csempét, ott külön PIN-kódos bejelentkezés van.
                </div>
              </form>
            )}
            ...
            {mode === 'sso' && (
              <div>
                <div className="mb-7">
                  <h2 className="text-[26px] font-semibold tracking-tight text-stone-900">
                    SSO bejelentkezés
                  </h2>
                  <p className="text-[13px] text-stone-500 mt-1">
                    Add meg a céges domain-t és átirányítunk az identitásszolgáltatóhoz.
                  </p>
                </div>
                <label className="block mb-4">
                  ...
                  <div className="mt-1 flex">
                    ...
                    />
                    <span className="h-10 px-3 inline-flex items-center bg-stone-50 border border-stone-200 rounded-r-lg text-[12.5px] text-stone-500 font-mono">
                      .joinerytech.hu
                    </span>
                  </div>
                </label>
                ...
                >
                  ← Vissza az emailes bejelentkezéshez
                </button>
              </div>
            )}
            ...
            {mode === 'forgot' && (
              <div>
                <div className="mb-7">
                  ...
                  <p className="text-[13px] text-stone-500 mt-1">
                    Add meg az email-t, küldünk egy visszaállító linket.
                  </p>
                </div>
                <label className="block mb-4">
                  <span className="text-[11px] font-medium text-stone-700">Email</span>
        ...
        <footer className="px-5 py-4 border-t border-stone-200 text-[11px] text-stone-500 flex items-center justify-between flex-wrap gap-2">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="#status" className="hover:text-stone-700 cursor-pointer">
              Állapotoldal
            </a>
