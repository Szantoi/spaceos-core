...
const WORLDS = {
  production: {
    ...
    screens: [
      ...
      { key: "supervisor", hu: "Üzemvezető",    en: "Supervisor" },
  ...
  shopfloor: {
    ...
    icon: "wrench",
    accent: "emerald",
    screens: [],  // shopfloor is full-screen kiosk, no mini-sidebar
    badge: "3 gép",
  },
  settings: {
    key: "settings",
...
const WORLD_ORDER = ["production", "sales", "design", "warehouse", "shopfloor", "settings"];
